 ...
 * AnimatePanel to display the simulation. SimFrame instantiates all the "state
 * control" buttons, defines their actionPerformed methods. SimFrame is the
 * "glue" that enables simulation of algorithms to be started, stopped, cleared,
 * and reset. It declares the abstract methods that it sub-class will have to
 * override. SimFrame should be sub-classed to define the simulation "main"
 * class that will setup the simulation model and begin its animation.
 *
 * <p>
...
public abstract class SimFrame extends JFrame {
    ...
    /**
     * Used to get time for the start or end an algorithm execution in
     * nanoseconds.
     * <p>
