 ...
 * "Clear" option is selected. * Marker's size has a default value of 2. Can be
 * changed with int getSize() and void setSize(int size).
 *
 * <p>
...
public class Marker implements Drawable {
    ...
    public void draw(Graphics g) {
        ...
        if (drawLabel) {
            g.drawString(label, (int) point.getX() - 2 * size, (int) point.getY() - 2 * size);
        }
    }
}