...
/**
 * AnimatePanel is the GUI component of the simulation framework package. It
 * uses a BorderLayout manager to have canvas for visually animating the
 * algorith in the center and a Box container of control buttons in the South.
 * The canvas is where the Bots, Markers, and Connectors are drawn. The control
 * buttons enable the user to:
 *
 * <ul type = disc>
...
public class AnimatePanel extends JPanel {
     ...
     * @param imageFile picture to use as canvas's background -- usually a
     * terrain
     */
    ...
    /**
     * Clear the display of all temporary drawable objects.
     */
